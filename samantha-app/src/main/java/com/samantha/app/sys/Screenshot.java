...
import static com.samantha.app.sys.Chmod.chmodPlusR;
import static com.samantha.app.sys.Chmod.chmodPlusRWX;

public class Screenshot {


    static final String SPOON_SCREENSHOTS = "samantha-screenshots";
    ...
    public static void screenshot(Activity activity, String tag) {
        ...
        try {
            ...
            Timber.d("Captured screenshot '" + tag + "'.");
        } catch (Exception e) {
